...
import com.aslan.personalguardianapp.util.XMLreaderDistance;
import com.aslan.personalguardianapp.view.PasswordAuthenticatorActivity;
import com.aslan.personalguardianapp.view.SplashActivity;
...
public class TrackingService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        number = Utility.getUserConf(getApplicationContext()).getGuardianPhone();
        Log.i("Phone", number);
        locationTraces = new ArrayList<>();
    ...
    public void showNotification(String text, boolean sendSMS,
        ...
        if (sendSMS && restart) {
            ...
            Intent intent3 = new Intent(getApplicationContext(),
                    PasswordAuthenticatorActivity.class);
            ...
            notification.tickerText = "Your travelling speed is lower than the average";
